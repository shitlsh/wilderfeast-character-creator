...
export default function App() {
  ...
  const showFloatingButtons = location.pathname === '/' || location.pathname.startsWith('/play/');
  ...
  return (
    <CharacterProvider>
      <div className="container mx-auto px-4 py-6 max-w-6xl">
        ...
        {/* Floating Reference Manual Button */}
        {showFloatingButtons && (
        ...
        {/* Backdrop */}
        {isManualDrawerOpen && (
          <div onClick={() => setIsManualDrawerOpen(false)} className="fixed inset-0 bg-stone-950/60 z-30 transition-opacity animate-fade-in print:hidden" />
        )}
        ...
        <Suspense fallback={<div className="text-xs text-ink-muted p-4 text-center">加载中...</div>}>
          <ReferenceManualDrawer
            ...
            setIsManualDrawerOpen={setIsManualDrawerOpen}
