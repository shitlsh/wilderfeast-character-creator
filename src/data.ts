...
// Upbringing options (20 rows) — match PDF page 27
export const UPBRINGINGS: BackgroundOption[] = [
  { id: 1, description: "野生的甜叶，是你在灌木丛中玩耍时觅食到的。你的父母告诉你，吃完一片才能再摘一片，免得你的贪婪惹怒了森林。", skill: "搜索" },
  { id: 2, description: "晒干的咸鱼干，在你手脚并用地爬上绳索时被紧紧叼在嘴里。你的船长不喜欢在船上生火，所以你们只能将就着吃些腌制品。", skill: "抓取" },
  { id: 3, description: "奶酪和一块面包皮，在你放牧的棉毛兽群的咩咩叫声中吃下。在天气好的日子里，你会尽可能慢地咀嚼，享受着微风、阳光和柔软的青草。", skill: "穿越" },
  { id: 4, description: "车站镇流动厨房里舀出的稀粥。孤儿们聚集在车站周围乞讨，大人们一转身，他们就扭打在一起。", skill: "打击" },
  { id: 5, description: "点缀着金箔的侧腹牛排。你的晚餐总是热腾腾地从庄园厨房端上来，但餐桌对面家人的眼神却冰冷刺骨。", skill: "储存" },
  { id: 6, description: "撒着肉桂粉的炸麻花。在市集摊位上叫卖到声音沙哑，你总会在轮班快结束时偷吃一两口。", skill: "发声" },
  { id: 7, description: "薄荷花茶，能缓解疼痛。即使在你病愈之后，药剂师也教会了你带给他们的每一种植物的用途。", skill: "治愈" },
  { id: 8, description: "坐在台阶上等待时吃的包子。整整一年，你每晚都在门廊上吃晚饭，直到你最终接受了父母不会回家的事实。", skill: "激励" },
  { id: 9, description: "和你脑袋一样大的蜜瓜橙，刚从寺庙花园里摘下来。晚祷前，你用自己做的盘子盛上切好的橙片分给大家。", skill: "手艺" },
  { id: 10, description: "鞍边肉干，用你在追踪途中猎到的野味制成。你那怪物坐骑如今已年迈嗜睡，但仍与你同住，只是你最近不常带它出去骑行了。", skill: "射击" },
  { id: 11, description: "炖蔬菜和一杯牛奶。在你就读的宪章组织寄宿学校里，他们给你吃的都是同样的餐食——据说是经过科学优化的饮食。", skill: "治愈" },
  { id: 12, description: "炒鸡蛋，里面还带着点蛋壳。练习杂耍时，导师让你吃掉每一个没接住的鸡蛋。", skill: "展示" },
  { id: 13, description: "饵鱼，被装饰得像奇迹食物一样。如果骗局没成功，你就会吃掉你试图兜售的食物，然后在第二天早上带着新捕的鱼重新开始。", skill: "展示" },
  { id: 14, description: "发酵蔬菜，香料味浓郁刺鼻。村民们总是把你带去的罐子装满他们做的泡菜，即使你已经撑得不行，也无法拒绝。", skill: "手艺" },
  { id: 15, description: "淡而无味的硬米饭，狱卒还在里面掺了锯末。但你还是吃了下去，这样当机会来临时，你才有力气逃跑。", skill: "打击" },
  { id: 16, description: "葱油拌面，配上香肠。在你打猎为家里挣来肉食的日子里，你的兄弟姐妹们总会为抢最好吃的那几口而打架。", skill: "射击" },
  { id: 17, description: "哐当火锅，这是你偷渡同伴给你们靠抢劫火车吃到的炖菜起的绰号。对你而言，货运车厢就是世界上最大的食品储藏室。", skill: "穿越" },
  { id: 18, description: "煮河蟹，用双手从浅滩里捞上来的。你的手指总是缠着绷带，但那多汁的蟹肉值得这一切。", skill: "抓取" },
  { id: 19, description: "印着祈祷符印的豆糕。长者们教导你每个符印的含义，时至今日，你仍能凭记忆画出所有符印。", skill: "激励" },
  { id: 20, description: "在你口中蠕动繁殖的蠕虫。你的监护人——如果他们能被这么称呼的话——利用你来探索世界更深层的奥秘。", skill: "学习" }
];

// Motivation options (20 rows) — match PDF page 29
export const MOTIVATIONS: BackgroundOption[] = [
  { id: 1, description: "在父母的手把手教导下。你的祖先曾立下神圣誓言，要守护荒野。你自幼便练习家族食谱。", skill: "手艺" },
  { id: 2, description: "在父母确认这确是你所愿之后。你被荒野食客收养，但他们迟迟不愿将这种生活强加于你。", skill: "激励" },
  { id: 3, description: "在父母困惑的低吼声中。你被怪物收养。为了保护它们和它们的家园，你学会了烹饪、交谈等各种人类的技能。", skill: "发声" },
  { id: 4, description: "在父母沉默而面如死灰的注视下。他们深知，家里要养活的嘴太多了。你踏上了追踪之路，以减轻他们的负担。", skill: "搜索" },
  { id: 5, description: "在你被诊断出患有狂厄之后。你加入猎群的条件是，如果诅咒恶化，他们会制约你。", skill: "治愈" },
  { id: 6, description: "为了拯救你的村庄。一只狂厄化的怪物威胁着你的家园。在下定决心烹食它之前，你尽可能地了解了它的一切。", skill: "学习" },
  { id: 7, description: "为了给你的村庄复仇。你没能及时拯救你的家园。当你杀死并吃掉毁灭家园的元凶时，它的肉在你舌尖尝起来如同灰烬。", skill: "射击" },
  { id: 8, description: "为了毁灭你的村庄。你邻居们的贪婪，威胁着与他们共享土地的所有生灵。你将荒野融入自身，只为能拯救它。", skill: "展示" },
  { id: 9, description: "作为对一桩滔天罪行的惩罚。一次暴力行径让你只剩下一个选择：要么成为一名荒野食客，要么被交给宪章组织。", skill: "打击" },
  { id: 10, description: "为了逃避一桩滔天罪行的惩罚。逃离家园后，偷窃并吃掉任何能找到的肉食，是你唯一的生存之道。", skill: "抓取" },
  { id: 11, description: "遵从长官的命令。将荒野食客改造为士兵的计划十分罕见，且从未有好下场。在所有被选中者中，你是唯一的幸存者。", skill: "射击" },
  { id: 12, description: "在签订一份契约后。一位富有的资助人承诺，只要你将一生献给追踪与狩猎，便会给你无尽的财富。他们的动机至今仍是个谜。", skill: "储存" },
  { id: 13, description: "为了治愈你的身体。你曾遭受重创，或身患使人衰弱的疾病。成为一名荒野食客，是活下去的唯一途径。", skill: "治愈" },
  { id: 14, description: "为了研究唯一律法。作为一名学者，亦是一名荒野食客，你需要亲身经历才能理解。你至今还保留着最初实验的笔记。", skill: "学习" },
  { id: 15, description: "为了见识唯一大陆。你渴望见识自己小小家园之外的世界，于是将身体改造得更适合在荒野中穿行。", skill: "穿越" },
  { id: 16, description: "它的孩子就在你的膝上。杀死那只狂厄化的怪物后，你发誓要抚养它新近成为孤儿的后代。", skill: "发声" },
  { id: 17, description: "在你成年之时。你一出生，便有预兆昭示了你的命运。为了履行职责，你获得了所需的一切资源与训练。", skill: "储存" },
  { id: 18, description: "出于意外。你没能认出狂厄化怪物的症状，直到身体开始变异，你才意识到自己吃了什么。", skill: "搜索" },
  { id: 19, description: "为了狩猎的荣耀。当你第一次在战斗中直面怪物时，你才发觉自己从未如此真切地活着。", skill: "打击" },
  { id: 20, description: "在悼念挚友之时。在它因狂厄而死后，为了纪念它，你成为了一名荒野食客。愿你们的遭遇，再也不会发生在任何人身上。", skill: "激励" }
];

// Ambition options (20 rows) — match PDF page 31
export const AMBITIONS: BackgroundOption[] = [
  { id: 1, description: "在温暖明亮的餐桌上，摆着满满当当的饭碗，身边是与你一同轻松欢笑的朋友。你希望有朝一日能再次足够信任某人，与他们共享这样一餐。", skill: "搜索" },
  { id: 2, description: "在你曾经攀爬的那棵树上，吃一份野餐三明治。你记得这个地方曾绿意盎然，鸟儿仍在歌唱。你希望当它痊愈时，你仍在此地。", skill: "抓取" },
  { id: 3, description: "你所照料的幼年怪物捕来的野味生肉片。一旦如此，你便知道你养大的怪物已能照顾好自己。", skill: "发声" },
  { id: 4, description: "在精英怪物倒下的地方，享用它的烤肉。若你能狩猎并烹饪一头狂厄化的神明，你的名字将被永远传唱。", skill: "展示" },
  { id: 5, description: "新鲜的田园沙拉。你从未在一个地方停留足够久，为自己种下食物。你想知道，创造与毁灭等量的事物是何种感觉。", skill: "手艺" },
  { id: 6, description: "一道古老的家族食谱，在绿王族覆灭时失传。了解你最古老的亲族，或许能助你与尚在人世的亲人重新建立联结。", skill: "手艺" },
  { id: 7, description: "从宪章组织偷来的奢侈腌制品，与它的敌人们一同分享。通过与反抗者们一同设宴，你将向他们展示合作能带来多大的益处。", skill: "射击" },
  { id: 8, description: "与你敬仰的荒野食客共饮一杯蜜酒。你幻想着向这位传奇人物展示你所有的战利品，交换着每一件背后的故事。", skill: "储存" },
  { id: 9, description: "来自最高峰顶的泉水。在攀上世界之巅后，你希望能有片刻来品味眼前的景色。", skill: "穿越" },
  { id: 10, description: "婚宴寿桃，你与挚爱并肩坐于上席。你的变异越是深入，你就越是怀疑这是否能成为现实。", skill: "激励" },
  { id: 11, description: "胜利的庆功酒，在你羞辱敌人，将他们的脸踩在尘土里之后举杯共饮。观众越多越好。", skill: "展示" },
  { id: 12, description: "一道前所未有的餐食。在唯一大陆的某处，甚至更远的地方，一定有你将成为第一个品尝的食材。", skill: "搜索" },
  { id: 13, description: "宫廷御膳房里裹满香料的菜肴，配上躬身的仆从与精美的瓷器。你从未享受过如此奢华的宴席，只想知道那是什么滋味。", skill: "储存" },
  { id: 14, description: "由你的恩师所创的一道菜。很久以前，他们便将食谱托付于你，但在你准备好烹饪它之前，仍有许多东西要学。", skill: "学习" },
  { id: 15, description: "从巨人盘中夺来的馅饼。你吃过最美味的餐食，总是那些被禁止享用的。", skill: "抓取" },
  { id: 16, description: "来自异域的糕点。你自幼便听闻关于此地的传说——尽管你的想象或许已超越了现实。", skill: "穿越" },
  { id: 17, description: "宪章组织风格的茶，是巨人们谈生意时专用的。据说巨人们知道如何在癌变之地生存，为了得到他们的药，你愿意做任何交易。", skill: "治愈" },
  { id: 18, description: "献给神圣怪物的裹糖苹果。向这只难以捉摸的传说野兽献上并分享祭品，将是至高无上的荣耀。", skill: "发声" },
  { id: 19, description: "一片来自界门之外的诡异蠕虫。你听过它的传说，也知道仍有许多东西有待探索。", skill: "学习" },
  { id: 20, description: "一颗巨人之心，血淋淋，生吞活剥。让他们亲眼看着自己的同类被吞食。", skill: "打击" }
];
...
// Connection Bond options (20 rows) — match PDF page 33
export const BONDS: BondOption[] = [
  { id: 1, type: '成长背景', description: '每次你吃这道餐食时，你的队友都在场，与你一同分享。' },
  { id: 2, type: '成长背景', description: '你的队友为了让你能吃上这道餐食而饿着肚子。' },
  { id: 3, type: '成长背景', description: '你发现你的队友时，他正饥肠辘辘地待在一个不属于他的地方，于是你为他端上了这道餐食。' },
  { id: 4, type: '成长背景', description: '同一个人为你们俩做过这道餐食。' },
  { id: 5, type: '成长背景', description: '你和你的队友在如何烹饪这道餐食上意见相左，争执不下。但在其他人尝来，两个版本没什么区别。' },
  { id: 6, type: '成长背景', description: '你的队友曾与你一同享用这道餐食，直到他的境况好转。' },
  { id: 7, type: '成长背景', description: '你的队友曾与你一同享用这道餐食，直到他的境况恶化。' },
  { id: 8, type: '动机', description: '当你杀死那只后来成为你第一顿荒野盛宴的怪物时，你救了你队友的命。' },
  { id: 9, type: '动机', description: '你的队友——一位经验丰富的荒野食客——为你猎来了你的第一顿荒野盛宴。' },
  { id: 10, type: '动机', description: '你和你的队友师从同一位导师。你独自享用了你的第一顿荒野盛宴，因为你的导师说你的队友还没准备好。' },
  { id: 11, type: '动机', description: '你的队友听闻了你第一顿荒野盛宴的故事，便前来向你求教。' },
  { id: 12, type: '动机', description: '你和你的队友在各自狩猎的怪物不期而遇时相识。你们二人联手，互相帮助对方拿下了各自的猎物。' },
  { id: 13, type: '动机', description: '你的队友认识并喜爱你吃掉的那只怪物。' },
  { id: 14, type: '动机', description: '你的队友认识并憎恨你吃掉的那只怪物。' },
  { id: 15, type: '雄心', description: '你的队友和你一样渴望吃到这道餐食。' },
  { id: 16, type: '雄心', description: '你的队友不理解你为何想要这道餐食。或许他们光是想想就觉得恶心。' },
  { id: 17, type: '雄心', description: '你的队友认为这样的餐食司空见惯。' },
  { id: 18, type: '雄心', description: '你的队友知道一个关于这道餐食的秘密，但他们犹豫着是否要告诉你。' },
  { id: 19, type: '雄心', description: '你的队友以前吃过这道餐食，并且满怀深情地回忆着它。' },
  { id: 20, type: '雄心', description: '你的队友以前吃过这道餐食，并且对此心怀悔意。' },
];
